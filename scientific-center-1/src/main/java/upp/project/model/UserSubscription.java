...
public class UserSubscription {
	...
	public UserSubscription(String uuid, Date expirationDate, OrderStatus subscriptionStatus, String successUrl, String errorUrl, String failedUrl, RegistredUser buyer) {
		super();
		this.uuid = uuid;
